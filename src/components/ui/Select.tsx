...
export const Select = forwardRef<HTMLSelectElement, SelectProps>(
  ({ label, error, helperText, options, className, id, disabled, required, ...props }, ref) => {
    ...
    const baseStyles =
      'w-full appearance-none rounded-lg border bg-white px-4 py-2 pr-10 text-gray-900 transition-colors duration-normal focus:outline-none focus:ring-2 focus:ring-offset-1 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-500';
